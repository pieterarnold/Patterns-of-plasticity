...
F2germ <- read.csv("/Users/u1058369/Dropbox/Pieter/ANU/Wahlenbergia project/F2 experiment 2019/F2 shape of RN manuscript/R saved data files/F2germ.csv")

# Remove the early replicates of lines that we later repeated in 2019
# remove <- c("201:1", "203:2", "205:1", "206:2", "207:3", "209:1", "220:2", "221:1", "229:1", "230:3", "237:3")

remove_block1 <- c("201", "205", "209", "221", "229")
remove_block2 <- c("203", "206", "220")
remove_block3 <- c("207", "230", "237")

# Mean-centre the x variable (temperature at dish level)
# From here on, use the mean-centred temperature (cTemp_rosette)
F2germ_block1 <- subset(F2germ, F2germ$Block=="1")
F2germ_block2 <- subset(F2germ, F2germ$Block=="2")
F2germ_block3 <- subset(F2germ, F2germ$Block=="3")
F2germ_block4 <- subset(F2germ, F2germ$Block=="4")
F2germ_block5 <- subset(F2germ, F2germ$Block=="5")

'%!in%' <- function(x,y)!('%in%'(x,y))
F2germ_block1 <- F2germ_block1[F2germ_block1$Line %!in% remove_block1,]
F2germ_block2 <- F2germ_block2[F2germ_block2$Line %!in% remove_block2,]
F2germ_block3 <- F2germ_block3[F2germ_block3$Line %!in% remove_block3,]

F2germ <- rbind(F2germ_block1, F2germ_block2, F2germ_block3, F2germ_block4, F2germ_block5)
...
F2data <- read.csv("/Users/u1058369/Dropbox/Pieter/ANU/Wahlenbergia project/F2 experiment 2019/F2 shape of RN manuscript/R saved data files/F2growth.csv")
...
Ped <- read.csv("/Users/u1058369/Dropbox/Pieter/ANU/Wahlenbergia project/F2 experiment 2019/F2 shape of RN manuscript/R saved data files/F2_TGP_pedigree.csv")
...
img1 <- readPNG("/Users/u1058369/Dropbox/Pieter/ANU/Wahlenbergia project/F2 experiment 2019/F2 shape of RN manuscript/20210122_092608_crop2.png")

img2 <- readPNG("/Users/u1058369/Dropbox/Pieter/ANU/Wahlenbergia project/F2 experiment 2019/F2 shape of RN manuscript/Fig1b_TGP_image.png")
